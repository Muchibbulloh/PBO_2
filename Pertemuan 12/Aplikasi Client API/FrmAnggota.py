...
class FrmAnggota:
    ...
    def aturKomponen(self):
        ...
        Cbo_prodi['values'] = ('TIF','ILKOM','PET','IND')
        Cbo_prodi.current()
        # Button
        ...
        # define columns
        columns = ('id_anggota','nim','nama','jk','prodi')
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["id_anggota"],d["nim"],d["nama"],d["jk"],d["prodi"]))
